    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                bat "cd ${PROJECT_DIR} &&   ${QT_INSTALL_DIR}\\qmake.exe plcsimulator.pro -spec C:\\Qt\\Tools\\mingw730_64\\ QMAKE_CXX=C:\\Qt\\Tools\\mingw730_64\\bin\\g++.exe && C:\\Qt\\Tools\\mingw730_64\\bin\\mingw32-make.exe"
