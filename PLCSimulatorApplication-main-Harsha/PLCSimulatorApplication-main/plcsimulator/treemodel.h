...
public:
    ...
    enum class AccessRole
    {
        ...
        FuzzInterval_s = Qt::UserRole + 6,
        SelectionWave = Qt::UserRole + 7
...
private:
    ...
    std::optional<QVariant> processInput(const QVariant& input, QVariant::Type, int min, int max);

    bool m_fuzz = false;
    bool m_filterSpare = false;
//    int noItr_Byte = 0;
//    int noItr_Int = 0;
     QStringList strlst_Byte_points,strlst_Int_points;
